...
const skills = [
  {
    ...
    description: "React, Next.js, Responsive UI Design, Modern JavaScript",
  ...
  },
  {
    ...
    description: "MERN Stack, MEAN Stack, End-to-End Application Development",
    gradient: "from-primary/10 to-primary/5",
  },
  {
    icon: Cloud,
    title: "CMS",
    description: "Wordpress ,Strapi , Sanity",
    gradient: "from-primary/20 to-primary/5",
  },
  {
    icon: Award,
    title: "Tools & Technologies",
    description: "Git, Docker, Tailwind CSS, TypeScript Github , GitLab Minio",
    gradient: "from-primary/15 to-primary/5",
  },
  {
    icon: Users,
    title: "Collaboration & Communication",
    description: "Agile Development, Team Collaboration, Clear Documentation",
    gradient: "from-primary/10 to-primary/5",
  },
]
